...
#plot 1,1 
plot(x = dt, y = dfSub$Global_active_power , type = "l", xlab = "", ylab = "Global Active Power")

#plot 1,2
plot(x = dt, y = dfSub$Voltage , type = "l", xlab = "datetime", ylab = "Voltage")
...
#plot 2,2 
plot(x = dt, y = dfSub$Global_reactive_power , type = "l", xlab = "datetime", ylab = "Global_reactive_power")
